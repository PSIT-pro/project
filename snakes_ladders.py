...
snake_sound = pygame.mixer.Sound("sound/OUCH.wav")
win = pygame.mixer.Sound("sound/Oh my god.wav")
lose = pygame.mixer.Sound("sound/o tai leaw.wav")
ladder = pygame.mixer.Sound("sound/Pipe.wav")
