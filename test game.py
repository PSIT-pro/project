...
#หน้าไอคอนเกม
icon = pygame.image.load("object/icon.png") #เลือกรูปไอคอน
icon = pygame.image.load("object/icon.png") #เลือกรูปไอคอน
pygame.display.set_icon(icon) #เซตรูปไอคอน

#ใส่ฉากหลัง
bg = pygame.image.load("object/BG.jpg") #เลือกฉากหลัง
...
#ภาพปุ่มสุ่ม
random = pygame.image.load("object/Random_Button.png")
random = pygame.transform.scale(random, (200,200))
